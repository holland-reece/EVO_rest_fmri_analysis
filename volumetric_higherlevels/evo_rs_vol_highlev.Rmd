...
Set variables
```{r}
datadir <- "/home/holland/Desktop/EVO_TEST/subjects" # main data directory
home_dir <- "/home/holland/Desktop/EVO_TEST" # place where this script and design matrix file are kept
setwd(home_dir) # set as working dir
