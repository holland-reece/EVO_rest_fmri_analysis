...
#     # if connectivity_data_session1.shape[1] != len(treatment_labels) or \
#     #    connectivity_data_session2.shape[1] != len(treatment_labels):
...
#         'Treatment': treatment_labels * 2  # Duplicate treatment labels for both sessions
#     })
...
# # and treatment_labels is a list.
